...
import {View, Dimensions, Image, Text, Slider, TouchableWithoutFeedback, TouchableOpacity, StatusBar, StyleSheet} from 'react-native';
...
export default class VideoPlayScreen extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
      visible: false,
      videoUrl: props.route.params.url,
      videoWidth: screenWidth,
      videoHeight: screenWidth * 9/16, // 默认16：9的宽高比
      showVideoCover: true,    // 是否显示视频封面
      showVideoControl: false, // 是否显示视频控制组件
      isPlaying: false,        // 视频是否正在播放
      currentTime: props.route.params.currentTime || 0,        // 视频当前播放的时间
      duration: 0,           // 视频的总时长
